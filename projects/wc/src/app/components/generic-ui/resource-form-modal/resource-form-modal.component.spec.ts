...
describe('ResourceFormModalComponent', () => {
  ...
  describe('open / close', () => {
    ...
    it('should open in create mode without a resource', async () => {
      await component.open();
      expect(component.isEditMode()).toBe(false);
      expect(component.dialogOpen()).toBe(true);
    });

    it('should open in edit mode when a resource is provided', async () => {
      await component.open(editResource);
  ...
  describe('onFieldChange / create validation', () => {
    beforeEach(async () => {
      fixture.componentRef.setInput('fields', [
        { property: 'metadata.name', required: true, label: 'Name' },
      ]);
    ...
    it('should require metadata.name on create', () => {
    ...
    it('should reject invalid metadata.name values on create', () => {
      component.onFieldChange({ fieldProperty: 'metadata.name', value: 'Bad_Name' });
      expect(component.fieldErrors()['metadata.name']).toBe(
  ...
  describe('onFormSubmit without open', () => {
    it('should emit the payload on create when no resource was loaded', () => {
